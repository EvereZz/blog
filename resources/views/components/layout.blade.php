...
<body style="font-family: Open Sans, sans-serif">
    <section class="px-6 py-8">
        <nav class="md:flex md:justify-between md:items-center">
            ...
            <a href="/">
            <img src="/images/default-monochrome.svg" class="" width="200" alt="logo" >
            </a>
            ...
            <div class="flex items-center md:mt-0 mt-8">
                ...
                <a href="#newsletter" class="bg-blue-500 hover:bg-blue-600 ml-6 rounded-full text-xs font-semibold text-white uppercase py-3 px-5">
